...
@page { margin: 0; }
	...
	$sql ="select * from reservation where booking_id = '$pid' ";
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$Bed_type = $row['bed'];
		// $Noof_room = $row['no_of_room'];
		$meal_type = $row['meal_plan'];
	...
	?>
		<header>
			...
			<address >
				<p>HOTEL SARKAR,</p>
				<p>Sp Road,<br>Bangalore,<br>India.</p>
				<p>(+91) 65 222 44 55</p>
			</address>
			<span><img alt="" src="image/sun.png"></span>
		</header>
		<article>
			<h1></h1>
			<address >
			...
			<table >
					...
					<tr> 
						<td>Customer Adhar no : -  <?php echo $adhar_no; ?> </td>
					</tr>
				</table>
				<br>
				<br>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@hotelsarkar.com || Web :- www.hotelsarkar.com || Phone :- +91 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
