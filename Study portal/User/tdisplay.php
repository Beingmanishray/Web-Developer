...
<div id="ta" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>Tutorial For HTML.</u></i><br/>
    <?php
...
<div id="tb" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>Tutorial For CSS.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="tc" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>Tutorial For MySQL.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="td" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>Tutorial For PHP.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="te" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>Tutorial For JavaScript.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="tf" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>Tutorial For C.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="th" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>Tutorial For JAVA.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
