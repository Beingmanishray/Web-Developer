...
<div id="qa" style="margin: -9% 0% 0% 8%">
    </br></br><i style="color: red;margin-left: 22%"><u>CBSC Question For Standerd 10th.</u></i><br/>
    <?php
        ...
        while ( $r=mysqli_fetch_assoc($qq)) {
            if ($r['course']=="10" && !$r['book']) {
                echo "<tr>
                <td>".$r['year']."</td>
                <td><a href='../Admin/question/$r[question]' download>$r[question]</a><td><br/>
                </tr>";
            }
        }
    ?>
</div>
<div id="qb" style="margin: -9% 0% 0% 30%">
    </br></br><i style="color: red;"><u>CBSC Question For ISC.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="qc" style="margin: -9% 0% 0% 30%">
    </br></br><i style="color: red;"><u>CBSC Question For IA.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="qd" style="margin: -9% 0% 0% 30%">
    </br></br><i style="color: red;"><u>CBSC Question For ICom.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="qe" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>CBCS Question For BCA.</u></i><br/>
    <div>
...
<div id="qf" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>CBCS Question For BBA.</u></i><br/>
    <div>
    <i style="color: red">1st Semester</i><br/>
    <?php
        $q="select * from admin_upload";
...
<div id="qg" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>CBCS Question For BSC.</u></i><br/>
    <div>
    <i style="color: red">1st Semester</i><br/>
    <?php
        $q="select * from admin_upload";
...
<div id="qh" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>CBCS Question For BCOM.</u></i><br/>
    <div>
    <i style="color: red">1st Semester</i><br/>
    <?php
        $q="select * from admin_upload";
...
<div id="qi" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>CBCS Question For BA.</u></i><br/>
    <div>
    <i style="color: red">1st Semester</i><br/>
    <?php
        $q="select * from admin_upload";
...
<div id="qj" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>CBCS Question For MCA.</u></i><br/>
    <div>
    <i style="color: red">1st Semester</i><br/>
    <?php
        $q="select * from admin_upload";
...
<div id="qk" style="margin: -9% 0% 0% 0%">
    </br></br><i style="color: red;margin-left: 30%"><u>CBCS Question For MBA.</u></i><br/>
    <div>
    <i style="color: red">1st Semester</i><br/>
    <?php
        $q="select * from admin_upload";
...
<div id="ql" style="margin: -9% 0% 0% 30%">
    </br></br><i style="color: red;"><u> Question For IAS.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="qm" style="margin: -9% 0% 0% 30%">
    </br></br><i style="color: red;"><u>Question For UPSC.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="qn" style="margin: -9% 0% 0% 30%">
    </br></br><i style="color: red;"><u>Question For Railway.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
...
<div id="qo" style="margin: -9% 0% 0% 30%">
    </br></br><i style="color: red;"><u>CBSC Question For SSC.</u></i><br/>
    <?php
        $q="select * from admin_upload";
        $qq=mysqli_query($con, $q);
        $n=mysqli_num_rows($qq);
